...
RSpec.describe AddressBook do
  ...
  it "imports the 1st entry" do
    ...
    check_entry(entry_one, "Tom", "444-444-5415", "tom@blocmail.com")
  ...
  it "imports the 2nd entry" do
    ...
    # Check the second entry
    entry_two = book.entries[1]
    check_entry(entry_two, "Sam", "444-444-4854", "sam@blocmail.com")
  ...
  it "imports the 3rd entry" do
    ...
    check_entry(entry_three, "Fred", "444-444-3660", "fred@blocmail.com")
